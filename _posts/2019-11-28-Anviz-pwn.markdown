---
layout: post
title:  "Anviz Pwn! How broken devices could be? (CVE-2019-12393/CVE-2019-12391/CVE-2019-12392/CVE-2019-12390/CVE-2019-12389/CVE-2019-12388/CVE-2019-12394)"
...
![SDK Download](images/anviz/anvizsdkdownload1.png)
...
![SDK Documentation](images/anviz/SDKword.png)
...
![Pointing to CRC Function](images/anviz/pii.png)
...
![Pointing to CRC Function](images/anviz/IDA-EVERYTHINGSPOINTTOCRC16.png)
...
![CRC Function](images/anviz/IDA-CRC.png)
...
![CRC Function Table](images/anviz/IDA-CRCtable.png)
...
![Anviz Export table](images/anviz/ExportTable.png)
...
## We need to go deeper! Exploiting the manager
...
While looking at the network traffic we noticed a small connection to an "UPDATE" service in plain HTTP. Could it be? Does it have space for an evilgrade attack in 2019? Well, yes it does =).
...
![Anviz Export table](images/anviz/cxupdate1.png)
...
![Anviz Export table](images/anviz/cxupdate2.png)
...
![Anviz Export table](images/anviz/cxupdate3.png)
...
![Anviz Export table](images/anviz/cxupdate4.png)
...
![Anviz Export table](images/anviz/cxupdate5.png)
...
![Anviz Export table](images/anviz/cxupdate6.png)
![Anviz Export table](images/anviz/cxupdate7.png)
